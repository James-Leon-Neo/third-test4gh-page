...
function init()
{
	...
	if(!parentNode)
	{
		parentNode=document.getElementById("wrapper")?document.getElementById("wrapper").getElementsByTagName("div")[0].getElementsByTagName("div")[1]:document;
	}
	...
	if(parentNode!=document&&!fraExam)
	{
